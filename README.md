...
Logs also include structural hashes for `request.queries`, `request.body`, and `response.body`. The body hashes are based on key structure only and ignore scalar values.
